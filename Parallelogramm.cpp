...
int main() {
    ...
    case 1: {
        ...
        cout << endl;
        cout << "Периметр параллелограмма: " << perimeter << endl;
        break;
    }
    case 2: {
        double ploshad = parallelogram.getploshad();
        cout << endl;
        cout << "Площадь параллелограмма: " << ploshad << endl;
        break;
    }
    case 3: {
        ...
        cout << endl;
        cout << "Диагональ параллелограмма 1: " << diagonal1 << "\n" << "Диагональ параллелограмма 2: " << diagonal2 << endl;
        break;
    }
    case 4: {
        double angle2 = parallelogram.getangle();
        cout << endl;
        cout << "Не забывайте, что противолежащие углы параллелограмма равны" << endl;
        cout << "Углы прилежащие к одной стороне:" << endl;
        cout << "Угол 1: " << angle << "\n" << "Угол 2: " << angle2 << endl;
        break;
    }
    case 5: {
        double storony = parallelogram.getsidebase();
        cout << endl;
        cout << "Основание параллелограмма: " << base << endl;
        cout << "Боковая сторона праллелограмма: " << side << endl;
        break;
    } 
    default:
